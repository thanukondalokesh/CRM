...
<div class="top-btn-row">
    <a href="index.cfm?fuse=home" class="btn-back-link">← Back to Home</a>

    <a href="index.cfm?fuse=customerspdf"
...
<div id="emailExistsModal" class="modal-overlay">
    <div class="modal-box">
        <h3 style="margin-top:0; text-align:center; color:#d93025;">⚠ Email Already Exists</h3>
