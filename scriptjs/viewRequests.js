...
if (pdfBtn) {
    pdfBtn.addEventListener("click", function () {
        ...
        let url = "/CRM/index.cfm?fuse=requestspdf";
...
function loadRequests() {
    ...
    // Correct REST URL (must include /CRM/)
    fetch(`/CRM/index.cfm?fuse=requestsajax&department=${encodeURIComponent(dept)}&searchText=${encodeURIComponent(search)}`)
        .then(res => res.json())
        .then(data => {
    renderTable(data);
    setupPagination(); 
...
function renderTable(data) {
    ...
    data.forEach(r => {
        ...
        <tr>
            ...
            <td>
                <a href="/CRM/index.cfm?fuse=editrequest&id=${r.id}" class="btn-edit">Edit</a>
                <a href="/CRM/index.cfm?fuse=deleterequest&id=${r.id}" class="btn-delete" 
